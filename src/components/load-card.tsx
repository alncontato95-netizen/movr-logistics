...
export function LoadCard({
  ...
  return (
    <Link
      href={href}
      className="group block rounded-[var(--radius-card)] border border-white/60 bg-white/75 p-5 shadow-[var(--shadow-float)] backdrop-blur-xl transition-all hover:-translate-y-1 hover:border-brand/20 hover:bg-white/90 hover:shadow-[0_16px_40px_rgba(14,18,22,0.10),0_4px_16px_rgba(58,175,66,0.10)]"
    >
